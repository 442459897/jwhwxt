...
public class AdminsApi extends AbstractApi {
	...
	@Consumes({ "application/json" })
	@Produces({ "application/json" })
	@io.swagger.annotations.ApiOperation(value = "\u65B0\u589E\u4EBA\u5458\u4FE1\u606F", notes = "", response = AdminInfo.class, tags = {
			"admins(人员管理相关)", })
	@io.swagger.annotations.ApiResponses(value = {
			@io.swagger.annotations.ApiResponse(code = 200, message = "\u83B7\u53D6\u4FE1\u606F\u6210\u529F", response = AdminInfo.class) })
	public Response addAdmin(@ApiParam(value = "\u4EBA\u5458\u4FE1\u606Fbody", required = true) AddAdmin admin,
	...
	@Consumes({ "application/json" })
	@Produces({ "application/json" })
	@io.swagger.annotations.ApiOperation(value = "\u6839\u636Eid\u5220\u9664\u4EBA\u5458\u4FE1\u606F", notes = "", response = void.class, tags = {
			"admins(人员管理相关)", })
	@io.swagger.annotations.ApiResponses(value = {
			@io.swagger.annotations.ApiResponse(code = 200, message = "\u5220\u9664\u4FE1\u606F\u6210\u529F", response = void.class) })
	public Response deleteAdminInfo(
			@ApiParam(value = "\u4EBA\u5458\u4FE1\u606FautoId", required = true) @PathParam("autoId") Long autoId,
			@Context SecurityContext securityContext) {
	...
	@Consumes({ "application/json" })
	@Produces({ "application/json" })
	@io.swagger.annotations.ApiOperation(value = "\u6839\u636Eid\u83B7\u53D6\u4EBA\u5458\u4FE1\u606F", notes = "", response = AdminInfo.class, tags = {
			"admins(人员管理相关)", })
	@io.swagger.annotations.ApiResponses(value = {
			@io.swagger.annotations.ApiResponse(code = 200, message = "\u83B7\u53D6\u4FE1\u606F\u6210\u529F", response = AdminInfo.class) })
	...
	@GET
	@Produces({ "application/json" })
	@io.swagger.annotations.ApiOperation(value = "\u83B7\u53D6\u4EBA\u5458\u4FE1\u606F\u5217\u8868", notes = "", response = PageData.class, responseContainer = "List", tags = {
			"admins(人员管理相关)", })
	@io.swagger.annotations.ApiResponses(value = {
	...
	@Produces({ "application/json" })
	@io.swagger.annotations.ApiOperation(value = "\u4FEE\u6539\u4EBA\u5458\u4FE1\u606F", notes = "", response = AdminInfo.class, tags = {
			"admins(人员管理相关)", })
	@io.swagger.annotations.ApiResponses(value = {
			@io.swagger.annotations.ApiResponse(code = 200, message = "\u83B7\u53D6\u4FE1\u606F\u6210\u529F", response = AdminInfo.class) })
	public Response updateAdmin(
			@ApiParam(value = "\u4EBA\u5458\u4FE1\u606FautoId", required = true) @PathParam("autoId") Long autoId,
			@ApiParam(value = "\u4EBA\u5458\u4FE1\u606FautoId", required = true) @FormParam("name") String name,
			@ApiParam(value = "", required = true) @FormParam("gender") Boolean gender,
			@ApiParam(value = "") @FormParam("mobile") String mobile,
			@ApiParam(value = "") @FormParam("email") String email,
			@ApiParam(value = "") @FormParam("idNumber") String idNumber, @Context SecurityContext securityContext) {
