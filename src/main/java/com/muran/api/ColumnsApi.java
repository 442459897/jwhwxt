...
public class ColumnsApi extends AbstractApi {
    ...
    @Consumes({"application/json"})
    @Produces({"application/json"})
    @io.swagger.annotations.ApiOperation(value = "\u680F\u76EE\u6D77\u62A5\u4FE1\u606F", notes = "\u83B7\u53D6\u680F\u76EE\u6D77\u62A5\u4FE1\u606F", response = ColumnConfig.class, tags = {"columns(栏目配置相关)",})
    @io.swagger.annotations.ApiResponses(value = {
            @io.swagger.annotations.ApiResponse(code = 200, message = "\u680F\u76EE\u6D77\u62A5\u4FE1\u606F\u83B7\u53D6\u6210\u529F\u3002", response = ColumnConfig.class),

            @io.swagger.annotations.ApiResponse(code = 400, message = "\u680F\u76EE\u6D77\u62A5\u4FE1\u606F\u83B7\u53D6\u5931\u8D25\u3002", response = ColumnConfig.class)})
    public Response getColumnConfigList(@Context SecurityContext securityContext) {
        return service.getColumnConfigList();
    }
    ...
    @Consumes({"application/x-www-form-urlencoded"})
    @Produces({"application/json"})
    @io.swagger.annotations.ApiOperation(value = "\u680F\u76EE\u6D77\u62A5\u4FE1\u606F", notes = "\u83B7\u53D6\u680F\u76EE\u6D77\u62A5\u4FE1\u606F", response = ColumnConfig.class, tags = {"columns(栏目相关)",})
    @io.swagger.annotations.ApiResponses(value = {
            @io.swagger.annotations.ApiResponse(code = 200, message = "\u680F\u76EE\u6D77\u62A5\u4FE1\u606F\u83B7\u53D6\u6210\u529F\u3002", response = ColumnConfig.class),

            @io.swagger.annotations.ApiResponse(code = 400, message = "\u680F\u76EE\u6D77\u62A5\u4FE1\u606F\u83B7\u53D6\u5931\u8D25\u3002", response = ColumnConfig.class)})
    public Response updateColumnConfig(@ApiParam(value = "\u680F\u76EE\u552F\u4E00key", required = true) @PathParam("autoId") Long autoId,
                                        @ApiParam(value = "\u6D77\u62A5url", required = true) @FormParam("showReadNum") Boolean bool,
                                        @Context SecurityContext securityContext) {
        return service.updateColumnConfig(autoId, bool);
    }
}
