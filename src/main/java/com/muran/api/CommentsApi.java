...
public class CommentsApi extends AbstractApi {
    ...
    public Response getCommentInfoPageList(@ApiParam(value = "\u9879\u76EE",required=true) @QueryParam("columnKey") String columnKey,@ApiParam(value = "\u9879\u76EE\u5BF9\u8C61",required=true) @QueryParam("itemId") Long itemId,@ApiParam(value = "\u83B7\u53D6\u7684\u6570\u91CF.\u9ED8\u8BA410\u6761",required=true) @QueryParam("pageSize") Integer pageSize,@ApiParam(value = "\u8D77\u59CB\u9875.\u9ED8\u8BA41",required=true) @QueryParam("pageIdex") Integer pageIdex,@ApiParam(value = "\u9879\u76EE\u5BF9\u8C61\u6807\u9898\u4FE1\u606F") @QueryParam("itemTitle") String itemTitle,@ApiParam(value = "\u65F6\u95F4(\u5FAE\u79D2,eg:1464110904319937).\u9ED8\u8BA4\u5F53\u524D\u65F6\u95F4") @QueryParam("startTime") Long startTime,@ApiParam(value = "\u65F6\u95F4(\u5FAE\u79D2,eg:1464110904319937).\u9ED8\u8BA4\u5F53\u524D\u65F6\u95F4") @QueryParam("endTime") Long endTime,@ApiParam(value = "\u72B6\u6001,0:\u5F85\u5BA1\u6838,1:\u5BA1\u6838\u901A\u8FC7,2:\u5BA1\u6838\u672A\u901A\u8FC7") @QueryParam("status") String status,@Context  SecurityContext securityContext){
        return service.getCommentInfoPageList(columnKey,itemId,pageSize,pageIdex,itemTitle,startTime,endTime,status,context());
    }
    @POST
