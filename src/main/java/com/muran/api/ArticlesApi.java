...
public class ArticlesApi extends AbstractApi {
    ...
    public Response getArticlesPageList(@ApiParam(value = "\u83B7\u53D6\u7684\u6570\u91CF.\u9ED8\u8BA410\u6761") @QueryParam("pageSize") Integer pageSize,@ApiParam(value = "\u8D77\u59CB\u9875.\u9ED8\u8BA41") @QueryParam("pageIdex") Integer pageIdex,@ApiParam(value = "\u65F6\u95F4(\u5FAE\u79D2,eg:1464110904319937).\u9ED8\u8BA4\u5F53\u524D\u65F6\u95F4") @QueryParam("startTime") Long startTime,@ApiParam(value = "\u65F6\u95F4(\u5FAE\u79D2,eg:1464110904319937).\u9ED8\u8BA4\u5F53\u524D\u65F6\u95F4") @QueryParam("endTime") Long endTime,@ApiParam(value = "\u680F\u76EE\u552F\u4E00key") @QueryParam("columnKey") String columnKey,@ApiParam(value = "\u6587\u7AE0\u6807\u9898") @QueryParam("title") String title,@ApiParam(value = "\u6587\u7AE0\u5173\u952E\u5B57") @QueryParam("keyword") String keyword,@ApiParam(value = "\u6587\u7AE0\u6765\u6E90") @QueryParam("source") String source,@ApiParam(value = "\u72B6\u6001,0:\u672A\u53D1\u5E03,1:\u5DF2\u53D1\u5E03,2:\u6536\u56DE") @QueryParam("status") String status,@Context  SecurityContext securityContext){
        return service.getArticlesPageList(pageSize,pageIdex,startTime,endTime,columnKey,title,keyword,source,status,context());
    }
    @PUT
    @Path("/{autoId}/publish")
    @Consumes({ "application/json" })
