...
public class ActivitySignupDao extends AbstractHibernateDao<ActivitySignup>implements IActivitySignUpDao {
	...
	@Override
	public Data<ActivitySignup> getActivitySignupPageList(Long autoId, Integer pageSize, Integer pageIndex) {
		// TODO Auto-generated method stub
		String hql = " from ActivitySignup where 1=1 ";
