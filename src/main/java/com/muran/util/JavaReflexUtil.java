...
public class JavaReflexUtil {
	...
	public static Method getGetMethod(Class objectClass, String fieldName) {
		...
		try {
			...
			// e.printStackTrace();
			// Log.d(TAG, "No get method for field: " + fieldName + " in " +
	...
	public static Method getSetMethod(Class objectClass, String fieldName) {
		try {
			...
			// e.printStackTrace();
			// Log.d(TAG, "No Field: " + fieldName + " in " +
			// objectClass.getSimpleName());
		} catch (NoSuchMethodException e) {
			// e.printStackTrace();
			// Log.d(TAG, "No set method for field: " + fieldName + " in " +
			// objectClass.getSimpleName());
		}
		return null;
	}
	 ...
	 *            值
	 */
	public static void invokeSet(Object o, Class clazz, String fieldName,
			Object value) {
		...
		try {
			...
			// " setmethod for filed:"+fieldName+"  IllegalAccessException");
		} catch (InvocationTargetException e) {
			// e.printStackTrace();
			// Log.d(TAG, "Class " + clazz + " setmethod for filed:" + fieldName
